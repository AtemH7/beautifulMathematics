...
function drawFrustum(p, xCenter, yCenter, zCenter, angleX, angleY, angleZ, dimensionBottom, dimensionTop, height, detailLevel) {
    let vertices = calculateFrustumVertices(dimensionBottom, dimensionTop, height, detailLevel);
